...
class LiquidGlassShaderView extends StatefulWidget {
  const LiquidGlassShaderView({super.key});

  @override
  State<LiquidGlassShaderView> createState() => _LiquidGlassShaderViewState();
}

class _LiquidGlassShaderViewState extends State<LiquidGlassShaderView> {
  ...
  Future<void> _loadShaderAndTexture() async {
    ...
    final byteData = await rootBundle.load('static/iOS26.png');
